<div class="jumbotron">
    <div class="row">
        <div class="col-md-8">
            <h1 class="text-center">StarterAPI</h1>
            <h3 class="text-justified">A basic API with blog posts, comments, and people resources generated using dummy data to fit your testing needs.</h3>
        </div>
